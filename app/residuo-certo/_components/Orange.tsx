      ...
      <>
        ...
        <Container>
          ...
          <Img src={Cover} alt="Contentor Vermelho" width={560} />
            <Title>Contentor laranja</Title>
            <Text>
              No contentor laranja você pode colocar suas baterias usadas, resíduo de solvente e resíduos de laboratório. Segregue da maneira correta e
